    ...
    if (resource === "comments") {
      ...
      return dataProvider
        ...
        .then(({ data, total, meta }) => ({
          ...
          pageInfo: {
            hasNextPage:
              params.pagination.perPage * params.pagination.page < (total || 0),
...
const postDataProvider = simpleDataProvider(
  "http://api.oauth2-proxy.localhost"
);
...
const sometimesFailsDataProvider = new Proxy(uploadCapableDataProvider, {
  get: (target, name) => (resource, params) => {
    ...
    if (resource === "posts") {
      return postDataProvider[name](resource, params);
    }
